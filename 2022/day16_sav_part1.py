...
class Puzzle:
    ...
    def depth_first_search_part1(self,
                                 current_valve: str,
                                 prev_actions: list,
                                 prev_time_left: int,
        ...
        if prev_time_left < 2 or len(valves_to_visit) == 0:
            ...
            for valve in valves_to_visit:
                ...
                if time_left > 1:
                    ...
                    self.depth_first_search_part1(valve, actions, time_left, next_valves_to_visit)
    ...
    def compute_most_pressure(self):
        ...
        origin = 'AA'
        self.depth_first_search_part1(origin, [], 30, self.valves_with_pressure)
...
if __name__ == '__main__':
    ...
    TestUtils.check_result("part1", 1651, puzzle_test.compute_most_pressure)
